...
<form id= "agee" method="post" action="">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-6"><h4><form name="bmiForm">
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <span class="w3-left w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="arthiritisName" value="1" id="arthiritis"> ARTHIRITUS </h3></span><HR>

      <span class="w3-right w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="heartName" value="2" id="heart"> HEART DISEASE</h3></span><HR><BR>


      <span class="w3-left w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="highbpName" value="3" id="highbp"> HIGH BLOOD PRESSURE</h3></span><HR>

      <span class="w3-right w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="lowbpName" value="4" id="lowbp"> LOW BLOOD PRESSURE</h3></span><br><HR>

      <span class="w3-left w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="astamaName" value="5" id="astama"> ASTAMA</h3><br></span><HR>


      <span class="w3-right w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="otherName" value="0" > OTHER DISEASES</h3></span><br>

      <span class="w3-right w3-tag w3-dark-grey w3-round"><h3><input type="radio" name="noName" value="0" > NO DISEASE</h3></span><br>
      <br>
...
<div class="w3-col w3-red w3-container" style="width:20%"><img src="bread.jpg" alt="Sandwich" style="width:100%" height="250px">
      ...
      <p>1 slice of brown bread = 73 calories<br>
        ...
        <input type="checkbox" name="bread" value="bread" id="bread">SELECT<br>
  ...
  <div class="w3-col w3-green w3-container" style="width:20%"><img src="cereals.jpg" alt="Sandwich" style="width:100%" height="250px">
      ...
      <p>100 gmsof cornflakes = 373 calories<br>
        ...
        <input type="checkbox" name="cereals" value="cereals" id="cereals">SELECT<br></div>
  <div class="w3-col w3-cyan w3-container" style="width:20%"><img src="fruit.jpg" alt="Sandwich" style="width:100%" height="250px">
      ...
      <p>Best diet is the one that includes fruits<br>
        <input type="checkbox" name="fruits" value="fruits" id="fruits">SELECT<br></div>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
  <div class="w3-content">
   ...
   <h1><b>SUPERMAN</b> <span class="w3-right w3-tag w3-dark-grey w3-round"><input type="checkbox" name="SUPERMAN" value="SUPERMAN" id="SUPERMAN">SELECT<br></span></h1>
      <p class="w3-text-grey">Upper body exercise</p>
      <hr>
...
-->
  ...
  <div class="w3-container w3-padding-32 w3-center">
    <h3>About , The CUSTOMISED PLANS</h3><br>
               <?php
                      $db = mysqli_connect("localhost","root","","fake_1");

                    if(isset($_POST['Submit'])){

                        $age = mysqli_real_escape_string($db,$_POST['ageName']);
                         $gender = mysqli_real_escape_string($db,$_POST['']);
                         $sql = "insert into age(ages)VALUES('$age')";
                         mysqli_query($db, $sql);
 ...
 <strong> <b><input form="agee" type="submit" name = "Submit" value="Submit" style = "height:50px; width :300px;  background-color: #99ff99; font-color:#000000;font-size: 2.0em; "/> </b></strong>
